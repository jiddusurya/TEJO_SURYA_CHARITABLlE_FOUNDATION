...
const Icon = ({ name, className }) => {
    const icons = {
        ...
        telescope: <svg xmlns="http://www.w3.org/2000/svg" width="46px" height="46px" viewBox="0 0 512 512"><path fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M39.93,327.56l-4.71-8.13A24,24,0,0,1,44,286.64l86.87-50.07a16,16,0,0,1,21.89,5.86l12.71,22a16,16,0,0,1-5.86,21.85L72.76,336.35A24.06,24.06,0,0,1,39.93,327.56Z" /><path fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M170.68,273.72,147.12,233a24,24,0,0,1,8.8-32.78l124.46-71.75a16,16,0,0,1,21.89,5.86l31.57,54.59A16,16,0,0,1,328,210.76L203.51,282.5A24,24,0,0,1,170.68,273.72Z" /><path fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M341.85,202.21l-46.51-80.43A24,24,0,0,1,304.14,89l93.29-53.78A24.07,24.07,0,0,1,430.27,44l46.51,80.43a24,24,0,0,1-8.8,32.79L374.69,211A24.06,24.06,0,0,1,341.85,202.21Z" /><line fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" x1="127.59" y1="480" x2="223.73" y2="272.01" /><line fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" x1="271.8" y1="256.02" x2="368.55" y2="448" /></svg>,
                ...
                <section className="bg-gradient-to-r from-rose-800 to-red-600 text-white">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
                            <Link href={"/donate"} className="bg-white text-rose-700 font-bold px-8 py-3 rounded-lg shadow-lg hover:bg-gray-100 transition-all transform hover:scale-105 flex items-center w-full sm:w-auto justify-center">
