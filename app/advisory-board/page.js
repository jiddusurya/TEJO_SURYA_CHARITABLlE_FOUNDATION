...
const AdvisoryBoardMemberCard = ({ member, onReadMore }) => {
    const truncatedDescription = member.description.length > 100
    ...
    return (
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 text-center h-full flex flex-col hover:shadow-xl transition-shadow duration-300">
            ...
            <button
                ...
                className="mt-4 text-red-500 font-semibold hover:text-red-600 transition-colors self-center"
            >
                Read More
            </button>
        </div>
...
const HelpTopicCard = ({ icon, title, children, color }) => {
    ...
    return (
        <div className="flex items-center bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <section className="py-16 md:py-20 text-center bg-white">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className='flex justify-center items-center'>
                            <div className="inline-block p-4 bg-blue-100 rounded-full mx-3 shadow-sm">
                                <Icon name="users" className="h-10 w-10 text-blue-600" />
                            </div>
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800">Advisory Board</h1>
                        </div>
                ...
                <section className="py-16 md:py-20 bg-gray-50">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12 md:mb-16">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800">How Our Advisory Board Helps</h2>
