                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <div className="mt-6 flex flex-wrap gap-2">
                                    <span className="text-xs font-semibold bg-green-100 text-green-800 px-3 py-1 rounded-full">80G Registered</span>
                                    <span className="text-xs font-semibold bg-green-100 text-green-800 px-3 py-1 rounded-full">12A Certified</span>
                                    <span className="text-xs font-semibold bg-green-100 text-green-800 px-3 py-1 rounded-full">FCRA Registered</span>
                                    <span className="text-xs font-semibold bg-green-100 text-green-800 px-3 py-1 rounded-full">CSR-1 Registered</span>
                                </div>
