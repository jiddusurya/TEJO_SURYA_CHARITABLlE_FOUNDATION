  ...
  const values = [
    {
      ...
      title: 'Compassion',
      color: 'blue',
      description: 'We approach every girl and woman with empathy, understanding their unique challenges and needs.'
    },
    {
      icon: 'sparkle',
      title: 'Empowerment',
      color: 'orange',
      description: 'We believe in giving girls and women the knowledge and tools to make informed decisions about their health.'
    },
    {
      icon: 'handshake',
      title: 'Inclusivity',
      color: 'yellow',
      description: 'Our programs are designed to reach every girl, regardless of her background or circumstances.'
    },
    {
      icon: 'bookOpen',
      title: 'Education',
      color: 'red',
      description: 'Knowledge is power. We provide comprehensive and age-appropriate health education.'
    },
    {
      icon: 'leaf',
      title: 'Sustainability',
      color: 'green',
      description: 'We build programs that create lasting change and can be maintained by communities themselves.'
    },
    {
      icon: 'lightbulb',
      title: 'Innovation',
      color: 'amber',
      description: 'We continuously improve our approaches based on the latest research and community feedback.'
    }
  ];
