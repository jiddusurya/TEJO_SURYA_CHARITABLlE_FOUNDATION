...
const PaymentSuccessModal = ({ isOpen, onClose, paymentId }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
                <div className="p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6">Thank you for your generous donation. Your contribution will make a real difference.</p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 mb-6">
                        ...
                        <div className="flex items-center justify-between bg-white border rounded-lg p-3">
                            ...
                            <button
                                ...
                                className={`ml-2 px-3 py-1 rounded text-xs font-medium transition-colors ${copied
        ...
        try {
            ...
            const options = {
                ...
                handler: function (response) {
                    ...
                    setIsModalOpen(false); // Close donation modal
                },
                prefill: {
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-8">
                            <button
                                ...
                                className="bg-[#e68541] text-white font-bold px-10 py-4 rounded-lg shadow-lg hover:bg-blue-950 transition-all transform hover:scale-105"
                            >
                                Donate Now
                            </button>
                        </div>
