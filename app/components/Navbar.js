        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-sm font-bold text-gray-800"><span className='text-xl font-bold text-[#ff712c]'>TEJO SURYA</span><br /><span className='text-xs font-medium text-[#073763]'>Charitable Foundation</span></span>
            </Link>
          </div>
