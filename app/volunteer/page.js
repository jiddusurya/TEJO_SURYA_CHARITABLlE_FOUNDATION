...
export default function VolunteerPage() {
  ...
  const helpOptions = [
    ...
    {
      icon: 'messageCircle',
      title: "Communications & Collaboration Support",
      description: "Help with communication strategies, partnerships, and stakeholder engagement.",
      color: 'blue'
    },
    {
      icon: 'target',
      title: "Planning & Strategic Support",
      description: "Assist with strategic planning, project management, and organizational development.",
      color: 'green'
    }
  ];
